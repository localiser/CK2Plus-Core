...
NDiplomacy = {
	...
	OFFER_VASSALIZATION_INTERACTION_PRESTIGE = 50,
	...
	ASK_FOR_VASSALIZATION_INTERACTION_PRESTIGE = 50,
...
NCharacter = {
	...
	RAISED_TROOPS_VASSAL_OPINION_DAYS = 36,		-- After 73 days of having their troops raised, vassals will get -1 opinion more of you
...
-- Monthly prestige from vassals
	...
	COUNT_AS_VASSAL_PRESTIGE = 0.075,
	DUKE_AS_VASSAL_PRESTIGE = 0.2,
	KING_AS_VASSAL_PRESTIGE = 1.0,
	EMPEROR_AS_VASSAL_PRESTIGE = 2.0, 	-- Impossible, but needs to be here
...
-- Monthly prestige LOSS from each unlanded adult son
	...
	COUNT_LANDLESS_SON_PRESTIGE = 0.10,
	DUKE_LANDLESS_SON_PRESTIGE = 0.25,
	KING_LANDLESS_SON_PRESTIGE = 1.0,
...
-- Title Grant Decadence Reduction (Multiplied with current decadence)
	...
	DE_JURE_ASSIMILATION_YEARS = 100000,		-- Duchies under the de facto control of another kingdom will change de jure liege after this many years
...
NMilitary = {
	...
	OVERRUN_RATIO = 5,								-- Ratio needed for total extermination of enemy units
	...
	DAYS_PER_FORTLEVEL_BEFORE_ASSAULT = 300000,			-- Number of days until attacker can assault
...
NAI =
{
	...
	REVOLT_DISTANCE_FACTOR = 0.75,							-- Multiplier for how much distance from capital affects independence minded revolters
