...
NDiplomacy = {
	...
	PREP_INV_REQ_PRESTIGE = 2000,				-- Need to have this much Prestige to prepare an invasion
	...
	PREPARE_INVASION_INTERACTION_PRESTIGE = 2000,
...
NCharacter = {
	...
	MUSLIM_NUM_WIVES_MONTHLY_PRESTIGE = 0.2,		-- The prestige effect from each extra or lacking expected wife
	PAGAN_NUM_CONSORTS_MONTHLY_PRESTIGE = 0.1,		-- The monthly prestige effect for pagans for each young Concubine
...
NTechnology = {
	...
	END_MIL_CATHOLIC    = 50.0,
	END_ECO_CATHOLIC    = 50.0,
	END_CUL_CATHOLIC    = 50.0,
	END_REN_CLOSE       = 50.0, -- Tech level at the center of the renaissance
	END_REN_FAR         = 40.0, -- Tech level on the fringe of the renaissance
	...
	END_MIL_BYZANTIUM   = 45,
	END_ECO_BYZANTIUM   = 45,
	END_CUL_BYZANTIUM   = 45,
},
